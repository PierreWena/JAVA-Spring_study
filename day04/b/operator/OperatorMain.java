...
public class OperatorMain {
	...
	/*
	    ...
	    이진수 00000 00000000 00000000 00001010000 이 되는데 이것을 십진수로 나타내면
	    1*(2의6승) + 1*(2의4승)
	     64 + 16 = 80 이 된다.
	...
	*/	
	...
	/*
	    ...
	    이것은 10 / (2의2승) ==> 10/(2의2승) 와 같은 것이 된다. 그러므로 2 이다.  
	 */
	 ...
	 /*
	    ...
	    10110000 
	    -1*(2의 7승) + 0*(2의 6승) + 1*(2의 5승) + 1*(2의 4승) 
	    -128 + 0 + 32 + 16 = -80 이 된다.      
	 */
	 //  -10 * (2의3승) ==> -80
	 
	    
	    System.out.println("n>>2 = " + (n>>2));  // n>>2 = -3 
	/*
	    >> 는 오른쪽 쉬프트 연산자
	    ...
	    그런 다음에 _ 자리에 정수 -10의 부호비트(가장 왼쪽 비트1개, 0 이면 양수이고, 1 이면 음수를 말하는 것이다) 와 같은 값으로 채운다.    
	    즉, 1 로 채운다.
	    즉, 1111111111 11111111 11111111 111101 이 된다.
	    이진수 11111111 11111111 11111111 11111101 이 되는데 이것을 십진수로 나타내면
	    음수이므로
	    
	    101
	    
	    -1*(2의2승) + 0*(2의1승) + 1*(2의0승)
	    -4 + 1 ==> -3
	 */   
	 ...
	 /*
	    ...
	    즉, 00011111111 11111111 11111111 11110 이 된다.
	 ...
	 //  또는
      ...
      System.out.println("\n=== 4. 논리 부정 연산자 !  ===");  
	  boolean bool = false;
	  System.out.println("bool : " + bool);   // bool : fasle
	  ...
	  /*
	       ...
	       | (or 연산자)  ==> 2개 bit 중에서 적어도 1개가 1 이면 1, 모두 0이어야만 0 
